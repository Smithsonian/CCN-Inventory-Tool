...
## older calculations
country_intersect_orig <- read_xls("global/data/mangroveCountryIntersect_Area.xls") 
eez_intersect_orig <- read_xls("global/data/mangroveEEZIntersect_Area.xls") 
...
mangrove_world_area_raw <- read_xls("global/data/mangroveWorld_Area.xls") 
